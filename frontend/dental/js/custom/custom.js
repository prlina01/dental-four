...
if (typeof DENTARIO_STORAGE == "undefined") var DENTARIO_STORAGE = {};
DENTARIO_STORAGE["ajax_url"] =
  "http://dentario.themerex.net/wp-admin/admin-ajax.php";
...
if (typeof DENTARIO_STORAGE == "undefined") var DENTARIO_STORAGE = {};
if (DENTARIO_STORAGE["theme_font"] == "")
  DENTARIO_STORAGE["theme_font"] = "Poppins";
DENTARIO_STORAGE["theme_skin_color"] = "#232A34";
DENTARIO_STORAGE["theme_skin_bg_color"] = "#ffffff";
    ...
    if (tpj("#rev_slider_1_1").revolution == undefined) {
      ...
      revapi1 = tpj("#rev_slider_1_1")
        ...
        .revolution({
          sliderType: "standard",
          jsFileLocation:
            "//dentario.themerex.net/wp-content/plugins/revslider/public/assets/js/",
          sliderLayout: "fullwidth",
          dottedOverlay: "none",
          delay: 7000,
          navigation: {
    ...
    jQuery("#esg-grid-1-1 .esgbox").esgbox({
      ...
      afterLoad: function() {
        if (this.element.hasClass("esgboxhtml5")) {
          ...
          this.content =
            '<div class="esg-lb-video-wrapper" style="width:100%"><video autoplay="true" loop=""  poster="" width="100%" height="auto"><source src="' +
            mp +
