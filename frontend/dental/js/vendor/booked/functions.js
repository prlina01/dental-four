  ...
  $win.on("load", function() {
    ...
    $(".booked-calendar-wrap").on("click", "tr.week td", function(e) {
      ...
      if (
        ...
        $("tr.entryBlock").remove();
        $thisRow.after(
          '<tr class="entryBlock loading"><td colspan="' +
            colspanSetting +
            '"></td></tr>'
        );
        $("tr.entryBlock")
    ...
    $(".booked-profile-appt-list").on("click", ".booked-show-cf", function(e) {
      ...
      e.preventDefault();
      var hiddenBlock = $(this)
        .parent()
        .find(".cf-meta-values-hidden");
    ...
    // Delete Appointment
    $(".booked-profile-appt-list").on("click", ".appt-block .cancel", function(
      e
    ) {
      "use strict";
        ...
        success: function(data) {
          if (data == "success") {
            ...
            $("form#ajaxlogin p.status")
              .show()
              .html(
                '<i class="fa fa-warning" style="color:#E35656"></i>&nbsp;&nbsp;&nbsp;' +
        ...
        success: function(data) {
          ...
          if (data == "success") {
            ...
            $("form#ajaxlogin p.status")
              .show()
              .html(
                '<i class="fa fa-check" style="color:#56c477"></i>&nbsp;&nbsp;&nbsp;' +
    ...
    $("body").on(
      ...
      function(e) {
        ...
        var customerType = $(
          ...
          guest_emailActive = $("#newAppointmentForm input[name=guest_email]")
            .length,
    ...
    var SubmitRequestAppointment = {
      ...
      newUser: function() {
        ...
        if (total_appts > 1) {
          ...
          data_obj_with_no_reference = SubmitRequestAppointment._addUserRegistrationData(
      ...
      _doRequestAppointment: function(data, total_appts) {
        ...
        data_obj_with_no_reference = SubmitRequestAppointment._addCustomFieldsData(
          data_obj_with_no_reference,
          calendar_id
        );
      ...
      _addUserRegistrationData: function(data) {
        ...
        $.each(SubmitRequestAppointment.userFields, function(
          index,
          field_name
        ) {
        ...
        $.each(SubmitRequestAppointment.captchaFields, function(
          index,
          field_name
        ) {
      ...
      _reloadCalendarTable: function() {
        ...
        var $activeTD = $("td.active"),
          ...
          calendar_id =
            parseInt($activeTD.parents("table").data("calendar-id")) || 0;
...
function adjust_calendar_boxes() {
  ...
  jQuery(".booked-calendar").each(function() {
    ...
    var smallCalendar = jQuery(this)
      .parents(".booked-calendar-wrap")
      .hasClass("small");
    var boxesWidth = jQuery(this)
      .find("tbody tr.week td")
      .width();
