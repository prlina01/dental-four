...
(window.Modernizr = (function(e, t, n) {
    ...
    w = function(e, n, r, o) {
      ...
      return (
        ...
        u
          ...
          : (f.parentNode.removeChild(f), (d.style.overflow = l)),
        !!a
      );
    },
    x = {}.hasOwnProperty;
  ...
  for (var S in E)
    u(E, S) &&
      ((s = S.toLowerCase()), (f[s] = E[S]()), j.push((f[s] ? "" : "no-") + s));
  return (
    (f.addTest = function(e, t) {
      if ("object" == typeof e) for (var r in e) u(e, r) && f.addTest(r, e[r]);
      else {
        ...
        return (
          (i = r.cache[e]
            ...
            : h.test(e)
              ...
              : r.createElem(e)),
          !i.canHaveChildren || p.test(e) || i.tagUrn
            ? i
    ...
    (d.className =
      d.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + j.join(" ")),
    f
  );
})(this, this.document)),
  (function(e, t, n) {
    ...
    function l(e, n, r, o, i, l, s) {
      ...
      1 === N[n] && ((v = 1), (N[n] = [])),
        ...
        "img" != e &&
          (v || 2 === N[n]
            ? (j.insertBefore(f, E ? null : m), h(u, s))
            : N[n].push(f));
    }
    function s(e, t, n, r, i) {
      return (
        ...
        (t = t || "j"),
        o(e)
          ? l("c" == t ? w : C, e, t, this.i++, n, r, i)
          : (y.splice(this.i++, 0, e), 1 == y.length && c()),
        this
      );
    }
    function u() {
    ...
    ((d = function(e) {
      ...
      if (o(e)) a(e, 0, f, 0);
        ...
        for (l = 0; l < e.length; l++)
          (s = e[l]),
            o(s) ? a(s, 0, f, 0) : x(s) ? d(s) : Object(s) === s && c(s, f);
