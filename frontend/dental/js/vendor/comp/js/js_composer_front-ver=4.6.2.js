    ...
    jQuery(".wpb_accordion").each(function(index) {
      ...
      var $tabs,
        ...
        active_tab =
          ...
          parseInt($this.data("active-tab")) > 0
            ? parseInt($this.data("active-tab")) - 1
            : false,
        collapsible =
          active_tab === false || $this.data("collapsible") === "yes";
      //
...
if (typeof window["vc_rowBehaviour"] !== "function") {
  window.vc_rowBehaviour = function() {
    ...
    $(window)
      .unbind("resize.vcRowBehaviour")
      .bind("resize.vcRowBehaviour", local_function);
