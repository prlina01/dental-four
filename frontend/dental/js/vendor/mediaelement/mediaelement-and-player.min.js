      ...
      (mejs.MediaElementPlayer.prototype = {
        ...
        remove: function() {
          ...
          c.isDynamic
            ...
            mejs.players[c.id].remove(),
            "object" == typeof c.container && c.container.remove(),
            c.globalUnbind(),
            c.node.player.remove();
        },
              ...
              h = a(
                ...
                .on("mouseover", function() {
                  if ("plugin-hover" == f.fullscreenMode) {
                    null !== g && (clearTimeout(g), g.remove());
                    var a = h.offset(),
        ...
        showSlide: function(b) {
          if (
            ...
            "undefined" == typeof e || "undefined" == typeof e.fadeIn
              ? (c.slides.entries.imgs[b] = e = a('<img src="' + d + '">').on(
                  "load",
                  function() {
    ...
    a.extend(mejs.MepDefaults, {
      ...
      a.extend(MediaElementPlayer.prototype, {
        ...
        killContextMenuTimer: function() {
          ...
          null != a && (clearTimeout(a), a.remove(), (a = null));
        },
