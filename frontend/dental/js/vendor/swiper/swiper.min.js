    ...
    t = function(e, s) {
      ...
      for (var g in f)
        if ("undefined" == typeof s[g]) s[g] = f[g];
          ...
          for (var v in f[g])
            "undefined" == typeof s[g][v] && (s[g][v] = f[g][v]);
      var w = this;
      if (
        ((w.version = "3.1.0"),
        (w.params = s),
        ...
        window.navigator.pointerEnabled
          ...
          (w.initEvents = function(e) {
            ...
            w.browser.ie
              ? (i[r](w.touchEvents.start, w.onTouchStart, !1),
                n[r](w.touchEvents.move, w.onTouchMove, o),
                n[r](w.touchEvents.end, w.onTouchEnd, !1))
              : (w.support.touch &&
                  (i[r](w.touchEvents.start, w.onTouchStart, !1),
                  i[r](w.touchEvents.move, w.onTouchMove, o),
                  i[r](w.touchEvents.end, w.onTouchEnd, !1)),
                !s.simulateTouch ||
                  w.device.ios ||
                  w.device.android ||
                  (i[r]("mousedown", w.onTouchStart, !1),
                  document[r]("mousemove", w.onTouchMove, o),
                  document[r]("mouseup", w.onTouchEnd, !1))),
        ...
        if (
          ...
          (w.onTouchEnd = function(e) {
            if (
              ...
              if (
                ...
                return void (
                  (!w.params.freeModeMomentum || r >= w.params.longSwipesMs) &&
          ...
          (w.slideTo = function(e, a, t, r) {
            ...
            w.params.autoplay &&
              w.autoplaying &&
              (r || !w.params.autoplayDisableOnInteraction
                ? w.pauseAutoplay(a)
                : w.stopAutoplay()),
              w.updateProgress(s);
                ...
                : ((s = window.getComputedStyle(e, null)),
                  window.WebKitCSSMatrix
                    ? (i = new window.WebKitCSSMatrix(
                        "none" === s.webkitTransform ? "" : s.webkitTransform
                      ))
                    : ((i =
                        s.MozTransform ||
                        s.OTransform ||
              ...
              function r(a) {
                (e =
                  ...
                  (i && "container" !== w.params.controlBy) ||
                    ...
                    (i = (e - w.minTranslate()) * s + a.minTranslate())),
