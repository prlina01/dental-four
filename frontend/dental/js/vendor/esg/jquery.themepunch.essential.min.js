...
!(function(jQuery, undefined) {
  function checkBottomPos(e, t) {
    var a =
        ...
        e.container.height() +
        (e.contPadTop + e.contPadBottom) -
        jQuery(document).scrollTop(),
      o = jQuery(window).height(),
      r = jQuery(document).height();
    ((e.lastBottomCompare != a && o >= a) ||
      (t && o >= a) ||
      (r === o && o > a)) &&
      ((e.lastBottomCompare = a),
      e.lmbut &&
        1 != e.lmbut.data("loading") &&
        (e.lmbut.data("loading", 1), loadMoreItems(e)));
  }
  ...
  function checkMoreToLoad(e) {
    ...
    for (var o = new Array(), r = 0; r < e.loadMoreItems.length; r++)
      jQuery.each(e.loadMoreItems[r][1], function(t, i) {
        jQuery.each(a, function(t, a) {
          a == i &&
            -1 != e.loadMoreItems[r][0] &&
            (0 == forcesearch ||
              (1 == forcesearch &&
                "cat-searchresult" === e.loadMoreItems[r][2])) &&
            o.push(e.loadMoreItems[r]);
        });
      });
    return addCountSuffix(t, e), o;
  }
  function addCountSuffix(e, t) {
    ...
    jQuery(
      ...
      if (0 == r.find(".eg-el-amount").length || a > 0) {
        ...
        for (
          var n = e.find("." + s).length, l = 0;
          l < t.loadMoreItems.length;
          l++
        ) {
          0 == o
            ? jQuery.each(t.loadMoreItems[l][1], function(e, a) {
                a === i && -1 != t.loadMoreItems[l][0] && n++;
              })
            : -1 != jQuery.inArray(i, t.loadMoreItems[l][1]) &&
              "cat-searchresult" === t.loadMoreItems[l][2] &&
              n++;
        }
        0 == r.find(".eg-el-amount").length &&
          r.append('<span class="eg-el-amount">0</span>'),
          countToTop(r, n);
      }
    }),
      jQuery(
  ...
  function buildLoader(e, t, a) {
    return t.esgloader != undefined && t.esgloader.length > 0
      ? !1
      : (e.append(
        ...
        (esgloader = e.find(".esg-loader")),
        ("spinner1" == t.spinner || "spinner2" == t.spinner) &&
          esgloader.css({ backgroundColor: t.spinnerColor }),
        ("spinner3" == t.spinner || "spinner4" == t.spinner) &&
          e
            .find(".bounce1, .bounce2, .bounce3, .dot1, .dot2")
            .css({ backgroundColor: t.spinnerColor }),
        a || punchgs.TweenLite.to(e, 0.3, { minHeight: "100px", zIndex: 0 }),
        esgloader);
  }
  function setKeyToNull(e, t) {
    jQuery.each(e.loadMoreItems, function(a, o) {
      o[0] == t &&
        ((e.loadMoreItems[a][0] = -1),
  ...
  function loadMoreItems(e) {
    ...
    if (
      ("scroll" === e.loadMoreType &&
        (e.esgloader.addClass("infinityscollavailable"),
        "add" != e.esgloaderprocess &&
          ((e.esgloaderprocess = "add"),
          punchgs.TweenLite.to(e.esgloader, 0.5, {
            autoAlpha: 1,
            overwrite: "all"
          }))),
      o.length > 0)
      ...
      e.lmbut.length > 0 &&
        (punchgs.TweenLite.to(e.lmbut, 0.4, { autoAlpha: 0.2 }),
            ...
            jQuery(
              ...
              setTimeout(function() {
                (e.animDelay = "off"),
                  ...
                  loadMoreEmpty(e)
                    ? e.lmbut.remove()
                    : ((e.lmtxt = e.loadMoreTxt + " (" + r + ")"),
                      "off" == e.loadMoreNr && (e.lmtxt = e.loadMoreTxt),
                      0 == r
                        ? e.lmbut.html(e.loadMoreEndTxt)
                        : e.lmbut.html(e.lmtxt),
                      e.lmbut.length > 0 &&
                        (punchgs.TweenLite.to(e.lmbut, 0.4, {
                          autoAlpha: 1,
                          overwrite: "all"
                        }),
      ...
      loadMoreEmpty(e)
        ? (e.lmbut.remove(),
          "scroll" === e.loadMoreType && e.esgloader.remove())
        : e.lmbut.data("loading", 0).html(e.loadMoreEndTxt);
  }
  ...
  function addAjaxNavigagtion(e, t) {
    ...
    (o = o + " eg-acp-" + e.ajaxCloseStyle),
      ...
      "type1" == e.ajaxCloseType &&
        ((loc = "eg-icon-left-open-big"),
        (roc = "eg-icon-right-open-big"),
        (e.ajaxCloseTxt = ""),
        (xoc = "X")),
      ("true" == e.ajaxCloseInner || 1 == e.ajaxCloseInner) &&
        (o += " eg-acp-inner");
    var r = '<div class="eg-ajax-closer-wrapper' + o + '">';
    switch (
      ("tr" == e.ajaxClosePosition || "br" == e.ajaxClosePosition
        ? ("on" == e.ajaxNavButton &&
            (r =
              r +
  ...
  function showHideAjaxContainer(e, t, a, o, r, i) {
    ...
    t
      ? ((r += 1.2),
        addAjaxNavigagtion(s, e),
        punchgs.TweenLite.set(e, { height: "auto" }),
        ...
        "off" != s.ajaxScrollToOnLoad &&
          jQuery("html, body").animate(
            { scrollTop: e.offset().top - o },
            { queue: !1, speed: 0.5 }
          ))
      : (i && (killOldCustomAjaxContent(e), (n = "0px")),
        punchgs.TweenLite.to(e.parent(), r, {
          height: n,
  ...
  function loadMoreContent(e, t, a) {
    ...
    var o = jQuery("#" + t.ajaxContentTarget)
        .find(".eg-ajax-target")
        .eq(0),
      r = a.data("ajaxsource"),
      i = a.data("ajaxtype"),
    ...
    if (
      ...
      switch (
        (t.ajaxJsUrl != undefined &&
          "" != t.ajaxJsUrl &&
          t.ajaxJsUrl.length > 3 &&
          jQuery
            .getScript(t.ajaxJsUrl)
            .done(function(e, a) {
              t.ajaxJsUrl = "";
            })
            .fail(function(e, a, o) {
        ...
        t.ajaxCssUrl != undefined &&
          "" != t.ajaxCssUrl &&
          t.ajaxCssUrl.length > 3 &&
          (jQuery("<link>")
            .appendTo("head")
          ...
          setTimeout(function() {
            o.data(
              ...
              o.data("ajaxload").success(function(e, r, i) {
                e.success &&
                  (jQuery(o).html(e.data),
                  showHideAjaxContainer(
                    o,
                    !0,
                    t.ajaxScrollToOnLoad,
                    t.ajaxScrollToOffset
                  ),
                  removeLoader(o),
                  ajaxCallBack(t, a));
              }),
              ...
              a != undefined &&
                ...
                setTimeout(function() {
                  o.data("lastposttype", i),
                    ...
                    o.data(
                      "oldselector",
                      "#" + t.ajaxContentTarget + " .eg-ajax-target"
                    ),
                    showHideAjaxContainer(
                      o,
                      !0,
                    ...
                    o.html(
                      a.func.call(this, { id: r, type: i, aspectratio: s })
                    ),
                    removeLoader(o);
                }, 300);
          });
        ...
        jQuery.each(o.split(","), function(a, o) {
          o !== undefined &&
            ...
            jQuery(
              ...
              (jQuery(this).data("fid") != o &&
                parseInt(jQuery(this).data("fid"), 0) !== parseInt(o, 0)) ||
                jQuery(this).hasClass("esg-pagination-button") ||
                (t ? jQuery(this).click() : jQuery(this).addClass("selected"),
                r++);
            });
        }),
          r > 0 &&
  ...
  function resetPaginationFromCookies(e, t) {
    if ("on" === e.cookies.pagination) {
      var a =
        t !== undefined ? t : readCookie("grid_" + e.girdID + "_pagination");
      a !== undefined &&
        null !== a &&
        a.length > 0 &&
        jQuery(
  ...
  function resetSearchFromCookies(e) {
    if ("on" === e.cookies.search) {
      ...
      t !== undefined &&
        null != t &&
        t.length > 0 &&
        (jQuery(e.filterGroupClass + ".eg-search-wrapper .eg-search-input")
          .val(t)
          .trigger("change"),
  ...
  function mainPreparing(e, t) {
    function a() {
      ...
      (t.lastsearchtimer = 1),
        buildLoader(
          jQuery(t.filterGroupClass + ".eg-search-wrapper"),
          { spinner: "spinner3", spinnerColor: "#fff" },
          !0
        ),
        punchgs.TweenLite.fromTo(
          jQuery(t.filterGroupClass + ".eg-search-wrapper").find(".esg-loader"),
          0.3,
          { autoAlpha: 0 },
      ...
      if ((a.attr("disabled", "true"), o.length > 0)) {
        ...
        jQuery
          ...
          .success(function(a, i, s) {
            if (
              ("on" === t.cookies.search &&
                createCookie(
                  "grid_" + t.gridID + "_search",
                  o,
                  t.cookies.timetosave * (1 / 60 / 60)
                ),
            ...
            setTimeout(function() {
              (t.lastsearchtimer = 0),
                ...
                punchgs.TweenLite.to(
                  jQuery(t.filterGroupClass + ".eg-search-wrapper").find(
                    ".esg-loader"
                  ),
                  0.5,
                  {
            ...
            jQuery.each(t.loadMoreItems, function(e, t) {
              (t[2] = "notsearched"),
                jQuery.each(u, function(e, a) {
                  return parseInt(t[0], 0) === parseInt(a, 0) &&
                    -1 != parseInt(t[0], 0)
                    ? ((t[2] = "cat-searchresult"), d++, !1)
                    : void 0;
                });
            }),
              ...
              jQuery(
                t.filterGroupClass + ".esg-filter-wrapper .esg-allfilter"
              ).trigger("click");
          })
        ...
        r.removeClass("eg-forcefilter").addClass("eg-justfilteredtosearch"),
          "on" === t.cookies.search &&
            createCookie("grid_" + t.gridID + "_search", "", -1),
          jQuery(
            t.filterGroupClass + ".esg-filter-wrapper .esg-allfilter"
          ).trigger("click"),
          setTimeout(function() {
    ...
    if (
      ...
      (t.mmHeight = r.mmHeight),
      prepareItemsInGrid(t),
      organiseGrid(t, "MainPreparing"),
      ...
      jQuery(
        t.filterGroupClass + ".esg-filter-wrapper.eg-search-wrapper"
      ).append(
        ...
        (t.lastsearchtimer = 0),
        n.click(a),
        jQuery(t.filterGroupClass + ".eg-search-wrapper .eg-search-input").on(
          "change",
          a
        ),
        l.click(function() {
    ...
    addCountSuffix(e, t),
      ...
      is_mobile() &&
        jQuery(document).on("click touchstart", function(e) {
          ...
          0 == a.length &&
            (t.container.find(".hoveredfilter").removeClass("hoveredfilter"),
            t.container
              .find(".esg-dropdown-wrapper")
              .stop()
              .hide());
      ...
      t.container.find(".esg-filters").each(function(e) {
        punchgs.TweenLite.set(this, { zIndex: 70 - e });
      }),
      t.container.find(".esg-filter-wrapper.dropdownstyle").each(function(e) {
        punchgs.TweenLite.set(this, { zIndex: 1570 - e });
      }),
      jQuery("body").on(
        "click",
        t.filterGroupClass + ".esg-left," + t.filterGroupClass + " .esg-left",
        function() {
          (t = getOptions(e)),
      ...
      jQuery("body").on(
        "click",
        t.filterGroupClass + ".esg-right," + t.filterGroupClass + " .esg-right",
        function() {
          (t = getOptions(e)),
            (t.oldpage = t.currentpage),
            t.currentpage++,
      ...
      jQuery(
        ...
        jQuery(this).hasClass("esg-pagination-button") ||
          jQuery(this).click(function() {
            ...
            stopAllVideos(!0);
            var a = jQuery(this);
            a.hasClass("esg-pagination-button") ||
              (jQuery(
                t.filterGroupClass +
                  ".esg-allfilter, " +
                  t.filterGroupClass +
              ...
              a.closest(".esg-filters").hasClass("esg-singlefilters") ||
              "single" == t.filterType
                ? (jQuery(
                    t.filterGroupClass +
                      ".esg-filterbutton, " +
                ...
                : a.hasClass("selected")
                  ...
                  : a.addClass("selected");
            var o = jQuery(
              t.filterGroupClass + ".esg-filter-wrapper .hiddensearchfield"
            );
            ...
            if (
                ...
                jQuery(this).hasClass("selected") &&
                  ...
                  (i =
                    0 === r
                      ...
                      : i + "," + jQuery(this).data("fid")));
              }),
              "on" === t.cookies.filter &&
                t.cookies.searchjusttriggered !== !0 &&
                createCookie(
                  "grid_" + t.girdID + "_filters",
                  i,
                  t.cookies.timetosave * (1 / 60 / 60)
                ),
              0 == r &&
              ...
              s > 0
                ? "off" == t.loadMoreNr
                  ? t.lmbut.html(t.loadMoreTxt)
                  : t.lmbut.html(t.loadMoreTxt + " (" + s + ")")
                : t.lmbut.data("loading", 0).html(t.loadMoreEndTxt);
            }
            setItemsOnPages(t),
    ...
    jQuery(window).on("resize.essg", function() {
      if (
        (clearTimeout(u), "on" == t.forceFullWidth || "on" == t.forceFullScreen)
      ) {
        var a = e
          .parent()
          .parent()
      ...
      } else e.closest(".esg-container-fullscreen-forcer").css({ left: 0, width: "auto" });
      if (o.length > 0) {
        ...
        clearTimeout(t.iteminspositiontimer),
          (t.iteminspositiontimer = setTimeout(function() {
            ...
            if (
              ...
              h.height() < 200 && (d = 1),
                ...
                punchgs.TweenLite.to(o, d, {
                  ...
                  clearProps: "transform",
                  onComplete: function() {
                    e.closest(".eg-grid-wrapper, .myportfolio-container")
                      .css({ height: "auto" })
              ...
              c.length > 0 && c.css({ marginTop: 0 - c.height() / 2 }),
                p.length > 0 && p.css({ marginTop: 0 - p.height() / 2 });
            ...
            e.data(
              ...
              t.firstLoadFinnished === undefined &&
                (e.trigger("essential_grid_ready_to_use"),
  ...
  function prepareSortingClicks(e) {
    ...
    jQuery(
      ...
      a.hasClass("tp-desc")
        ...
        : (a.removeClass("tp-asc").addClass("tp-desc"), a.data("dir", "desc"));
      var o = a.data("dir");
      stopAllVideos(!0, !0),
        jQuery(
          opt.filterGroupClass +
          ...
          clearTimeout(t),
            e
              .find(".tp-esg-item")
              .tsort({ data: a, forceStrings: "false", order: o }),
      ...
      jQuery(
        ...
        a.change(function() {
          ...
          var n = e
            .find(".tp-esg-item")
            .tsort({ data: r, forceStrings: "false", order: s });
          n !== undefined &&
            ((opt = getOptions(e)),
            setItemsOnPages(opt),
  ...
  function fixCenteredCoverElement(e, t, a) {
    if (
      ...
      var r = e.find(".esg-cc");
      punchgs.TweenLite.set(r, { top: (o - r.height()) / 2 });
    }
  }
  function getBestFitColumn(e, t, a) {
    ...
    e.responsiveEntries != undefined &&
      e.responsiveEntries.length > 0 &&
      jQuery.each(e.responsiveEntries, function(e, t) {
        ...
        : t
          ...
          : t
            ...
            : t
                .attr("src")
                .toLowerCase()
                .indexOf("soundcloud") > 0 && prepareSoundCloud(t);
    }),
  ...
  function hideUnderElems(e) {
    e.find(".eg-handlehideunder").each(function() {
      ...
      t.data("knowndisplay") == undefined &&
        ...
        (e.width() < a && a != undefined) || (e.height() < o && o != undefined)
          ? "visibility" == r
            ? t.addClass("forcenotvisible")
            : "display" == r && t.addClass("forcenotdisplay")
          : "visibility" == r
            ? t.removeClass("forcenotvisible")
            : "display" == r && t.removeClass("forcenotdisplay");
    });
  }
  function offsetParrents(e, t) {
    var a = t.closest(".mainul"),
      o = a.parent();
    if (
      t.position().top + t.height() > a.height() + 40 ||
      0 == e ||
      (0 != a.data("bh") &&
        a.data("bh") != undefined &&
        t.position().top + t.height() > parseInt(a.data("bh"), 0) + 40)
    ) {
      (a.data("bh") == undefined || 0 == a.data("bh")) &&
        a.data("bh", a.height()),
        (o.data("bh") == undefined || 0 == o.data("bh")) &&
          o.data("bh", o.height());
      var r = a.data("bh"),
        i = o.data("bh");
      0 != e
        ? (a.data("alreadyinoff", !1),
          punchgs.TweenLite.to(a, 0.2, { height: r + e }),
          punchgs.TweenLite.to(o, 0.2, { height: i + e }))
        : a.data("alreadyinoff") ||
          (a.data("alreadyinoff", !0),
          punchgs.TweenLite.to(a, 0.3, {
            height: r,
  ...
  function itemHoverAnim(e, t, a, o) {
    if (
      ...
      e.find(".isplaying, .isinpause").length > 0)
    )
      return !1;
    ...
    "set" == t && (r = 0),
      e.data(
        ...
        setTimeout(function() {
          ...
          if (
            (punchgs.TweenLite.set(r, { transformStyle: "flat" }),
            "set" != t && fixCenteredCoverElement(e, r),
            ...
            e.css({
              ...
              1 != a.inanimation &&
                punchgs.TweenLite.set(e.closest(".esg-overflowtrick"), {
                  overflow: "visible",
                  overwrite: "all"
                });
          }
          jQuery.each(esgAnimmatrix, function(a, r) {
            e.find(r[0]).each(function() {
              ...
              a.hasClass("esg-entry-media") ||
                ...
                a.hasClass("esg-overlay") &&
                  (animfrom.z == undefined && (animfrom.z = -0.002),
                  (animto.z = -1e-4));
              var l = a;
              if (
                a.hasClass("esg-entry-media") &&
                a.find(".esg-media-video").length > 0
              )
                return !0;
              ...
              if ("set" == t) {
                ...
                punchgs.TweenLite.set(e.find(".esg-entry-cover"), {
                  ...
                  n && u.eventCallback("onComplete", resetTransforms, [l]);
              } else
                switch (r[0]) {
                  case ".esg-shifttotop":
                    animto.y =
                      ...
                      e
                        ...
                        .last()
                        .height();
                    var u = punchgs.TweenLite.fromTo(
                      a,
                      0.5,
                      { y: 0 },
                      { y: animto.y }
  ...
  function videoClickEvent(e, t, a, o) {
          ...
          (t.data("mp4") == undefined &&
            ...
            t.data("mp4") != undefined &&
              a
                .find("video")
                .append(
                  '<source src="' + t.data("mp4") + '" type="video/mp4" />'
                ),
            t.data("webm") != undefined &&
              a
                .find("video")
                .append(
                  '<source src="' + t.data("webm") + '" type="video/webm" />'
                ),
            t.data("ogv") != undefined &&
              a
                .find("video")
    ...
    (vt = "y"),
      ...
      "about:blank" == r.attr("src")
        ? r.attr("src", r.data("src"))
        : r.hasClass("esg-video-frame")
          ? punchgs.TweenLite.set(r, { opacity: 0, display: "block" })
          : (go = !0),
      loadVideoApis(t, a),
      o || punchgs.TweenLite.set(r, { opacity: 0, display: "block" });
    var n = setInterval(function() {
      (go ||
        ("y" == vt && prepareYT(r)) ||
        ("v" == vt && prepareVimeo(r)) ||
        ("w" == vt && prepareWs(r)) ||
        ("s" == vt && prepareSoundCloud(r)) ||
        ("h" == vt && prepareVideo(r))) &&
        (clearInterval(n),
        o ||
          (is_mobile()
            ? (punchgs.TweenLite.set(r, { autoAlpha: 1 }),
              punchgs.TweenLite.set(s, { autoAlpha: 0 }),
              punchgs.TweenLite.set(i, { autoAlpha: 0 }))
            : (punchgs.TweenLite.to(r, 0.5, { autoAlpha: 1 }),
              punchgs.TweenLite.to(s, 0.5, { autoAlpha: 0 }),
              punchgs.TweenLite.to(i, 0.5, { autoAlpha: 0 }),
              ("y" === vt || "w" === vt) && playYT(r, o)),
          "v" === vt && playVimeo(r, o),
          "s" === vt && playSC(r, o),
          "h" === vt && playVideo(r, o)),
        r.attr("src") != undefined &&
          (r
            .attr("src")
            .toLowerCase()
            .indexOf("youtube") > 0 && playYT(r, o),
          r
            .attr("src")
            .toLowerCase()
            .indexOf("vimeo") > 0 && playVimeo(r, o),
          r
            .attr("src")
            .toLowerCase()
            .indexOf("wistia") > 0 && playWs(r, o),
          r
            .attr("src")
            .toLowerCase()
            .indexOf("soundcloud") > 0 && playSC(r, o)));
    }, 100);
  }
  function setMediaEntryAspectRatio(e) {
    var t = e.img !== undefined ? e.img.attr("width") : 1,
      a = e.img !== undefined ? e.img.attr("height") : 1;
    (e.ar === undefined || "auto" == e.ar || NaN === e.ar) &&
      ((e.imgw =
        e.imgw === undefined
          ? e.img != undefined
            ? e.img.width()
      ...
      (e.imgh =
        ...
        e.imgh === !1
          ...
          : e.imgh),
      (e.imgw =
        e.img != undefined ? (t !== undefined && t !== !1 ? t : e.imgw) : 1),
      (e.imgh =
        e.img != undefined ? (a !== undefined && a !== !1 ? a : e.imgh) : 1),
      (e.ar =
  ...
  function prepareItemsInGrid(e, t) {
    ...
    a.addClass("esg-container"),
      t ||
        a.find(".mainul>li").each(function() {
    ...
    (r = r.split(":")),
      r.length > 1
        ? ((n = parseInt(r[0], 0) / parseInt(r[1], 0)),
          (l = parseInt(r[1], 0) / parseInt(r[0], 0)),
          (s = i / e.column / n),
          (kar = !0),
          (l = 100 * l))
        : ((n = "auto"), (l = "auto"), (kar = !1));
    for (var u = 0; u < o.length; u++) {
      ...
      f === undefined && (f = g),
        ...
        punchgs.TweenLite.set(c, { force3D: "auto", autoAlpha: 0, opacity: 0 }),
        c.addClass("tp-esg-item");
      var m = {
        bgpos:
          h.length >= 1 && h != undefined ? h.data("bgposition") : undefined,
        bgsize: h.length >= 1 && h != undefined ? h.data("bgsize") : undefined,
        bgrepeat:
          h.length >= 1 && h != undefined ? h.data("bgrepeat") : undefined
      };
      (m.bgpos =
        m.bgpos === undefined ? "" : "background-position:" + m.bgpos + ";"),
        (m.bgsize =
          m.bgsize === undefined ? "" : "background-size:" + m.bgsize + ";"),
        (m.bgrepeat =
          m.bgrepeat === undefined
            ? ""
            : "background-repeat:" + m.bgrepeat + ";"),
        p.append(
        ...
        h != undefined && h.length > 0 && h.css({ display: "none" }),
        c.find(".esg-media-video").each(function() {
          ...
          if (
            (t.data("poster") != undefined && t.data("poster").length > 3
              ...
              : (c.find(".esg-entry-cover").remove(),
                c.find(".esg-media-poster").remove(),
                (o = "display:block;"),
                (r = "src="),
                (i = "data-src="),
                (l =
                  ...
                  100),
                setMediaEntryAspectRatio({ ip: p, ar: l, keepAspectRatio: !0 }),
                c.data("simplevideo", 1)),
            0 == c.find(".esg-click-to-play-video").length &&
              (c
              ...
              c.find(".esg-overlay").addClass("esg-click-to-play-video")),
            t.data("youtube") != undefined)
          ) {
            var s =
              "https://www.youtube.com/embed/" +
        ...
        0 == c.find(".esg-media-video").length &&
          c.find(".esg-click-to-play-video").remove(),
        adjustMediaSize(c, !0, null, e),
        c.find(".esg-entry-content").length > 0 &&
          c.find(".esg-media-cover-wrapper").length > 0 &&
          (c.find(".esg-entry-content").index() <
            c.find(".esg-media-cover-wrapper").index() ||
            c.find(".esg-entry-content").addClass("esg-notalone")),
        c.find(".esg-entry-cover").each(function(e) {
          ...
          t.css({ visibility: "hidden" }),
            ...
            "on" == a &&
              ...
              t
                .click(function(e) {
                  0 == jQuery(e.target).closest("a").length &&
                    jQuery(this)
        ...
        e.ajaxContentTarget != undefined &&
          jQuery("#" + e.ajaxContentTarget).length > 0 &&
          c.find(".eg-ajaxclicklistener, a").each(function() {
            var t = jQuery(this),
              o = jQuery("#" + e.ajaxContentTarget).find(".eg-ajax-target");
            o.parent().hasClass("eg-ajaxanimwrapper") ||
              o.wrap(
        ...
        c.on("mouseenter.hoverdir, mouseleave.hoverdir", function(t) {
          ...
          if ("mouseenter" === t.type)
            ...
            if (
              (clearTimeout(a.data("hovertimer")), 1 == a.data("animstarted"))
            ) {
              ...
              a.find(".esg-entry-content").length > 0 &&
                ...
                punchgs.TweenLite.set(a, { zIndex: 5 }),
                ...
                jQuery.each(esgAnimmatrix, function(e, t) {
                  a.find(t[0]).each(function() {
                      ...
                      case ".esg-slide":
                        ...
                        var u = punchgs.TweenLite.to(animobject, 0.5, {
                          ...
                          onComplete: function(e) {
                            punchgs.TweenLite.set(e, { autoAlpha: 0 });
                          }
                        });
                        break;
                      case ".esg-slideout":
                        ...
                        (s.x = 0), (s.y = 0), (s.overwrite = "all");
                        var u = punchgs.TweenLite.fromTo(
                          animobject,
                          0.5,
                          { autoAlpha: 1, x: l.x, y: l.y },
                    ...
                    isOut &&
                      u.eventCallback("onComplete", resetTransforms, [
                        animobject
                      ]);
                  });
                });
        ...
        itemHoverAnim(c, "set", e),
        c.hasClass("esg-demo") && itemHoverAnim(c);
    }
    loadVideoApis(a, e),
      setItemsOnPages(e),
    ...
    "" !== r &&
      e.find(r).each(function(r) {
        ...
        (s = a != undefined ? a.itemw : e.width()),
          ...
          i.data("newh", n),
          t && "even" != o.layout
            ? punchgs.TweenLite.set(i, { width: s, height: n })
            : punchgs.TweenLite.set(i, { width: "100%", height: "100%" });
      });
  }
  function setItemsOnPages(e) {
    ...
    if ("on" == e.evenCobbles && e.cobblesPattern != undefined) {
      ...
      jQuery.each(a, function(t, a) {
        ...
        if (e.cobblesPattern != undefined && e.cobblesPattern.length > 2) {
          ...
          (i = parseInt(n.w, 0)), (s = parseInt(n.h, 0));
        }
        (i = i == undefined ? 1 : i),
          (s = s == undefined ? 1 : s),
    ...
    f.find(".esg-pagination").remove(), f.html(""), (e.maxpage = 0);
    var m,
      w = Math.ceil(e.nonefiltereditems / o);
    if (((e.realmaxpage = w), w > 7 && "on" == e.smartPagination))
      if (e.currentpage < 3) {
        for (var s = 0; 4 > s; s++)
          (m = s == e.currentpage ? "selected" : ""),
            e.maxpage++,
            f.append(
        ...
        f.append(
          ...
          f.append('<div class="esg-navigationbutton">...</div>');
        for (var s = e.currentpage - 1; s < e.currentpage + 2; s++)
          (m = s == e.currentpage ? "selected" : ""),
            e.maxpage++,
            f.append(
              '<div class="esg-navigationbutton esg-filterbutton esg-pagination-button ' +
    ...
    e.currentpage < 0 && (e.currentpage = 0),
      f.find(".esg-pagination-button").on("click", function() {
        ...
        (e.column = a.column),
          ...
          "on" === e.cookies.pagination &&
            e.cookies.searchjusttriggered !== !0 &&
            createCookie(
              "grid_" + e.girdID + "_pagination",
              e.currentpage,
              e.cookies.timetosave * (1 / 60 / 60)
            ),
          setItemsOnPages(e),
          organiseGrid(e, "paginholder"),
          setOptions(t, e),
          stopAllVideos(!0),
          "on" == e.paginationScrollToTop &&
            jQuery("html, body").animate(
              { scrollTop: t.offset().top - e.paginationScrollToTopOffset },
              { queue: !1, speed: 0.5 }
            );
      }),
      e.firstshowever == undefined &&
        jQuery(
          e.filterGroupClass +
            ".esg-navigationbutton," +
            e.filterGroupClass +
    ...
    setMediaEntryAspectRatio({ ip: o, img: e, imgw: t, imgh: a }),
      !e.hasClass("coverremoved") && o.find(".lazyloadcover").length > 0
        ? (e.addClass("coverremoved"),
          punchgs.TweenLite.set(o.find(".lazyloadcover"), { zIndex: 0 }),
          punchgs.TweenLite.fromTo(
            e,
            0.5,
        ...
        : "off" == opt.lazyLoad &&
          punchgs.TweenLite.set(e, { force3D: !0, autoAlpha: 1 });
  }
  function runGrid(e, t) {
    ...
    "scroll" == e.loadMoreType && checkBottomPos(e),
      e.firstshowever == undefined
        ? (a.is(":hidden") &&
            punchgs.TweenLite.set(a, { autoAlpha: 1, display: "block" }),
          runGridMain(e, t),
          jQuery(
            e.filterGroupClass +
              ".esg-navigationbutton, " +
  ...
  function runGridMain(e, t) {
    ...
    (i.y = 0),
      (i.fakey = 0),
      o.find(".esg-overflowtrick").css({ width: "100%" }),
      100 == o.find(".esg-overflowtrick").width() &&
    ...
    "even" == e.layout
      ? ((i.itemh =
          0 == Math.round(l)
            ? Math.round(i.cwidth_n_spaces / e.column / a)
            : Math.round(l / e.row)),
        (e.aspectratio = 0 == l ? e.aspectratio : i.itemw + ":" + i.itemh),
        c > 0
    ...
    0 == r.length && o.trigger("itemsinposition"),
      jQuery.each(r, function(t, r) {
        ...
        if (
          ...
          "on" != e.evenCobbles ||
            n.hasClass("itemonotherpage") ||
            n.hasClass("itemishidden"))
        ) {
          var u = i.row - c * Math.floor(i.row / c);
          if (
            ("even" == e.layout &&
              c > 0 &&
              ((e.column = d[u][e.columnindex]),
              (i.cwidth =
                o.find(".esg-overflowtrick").width() - 2 * e.overflowoffset),
              (i.cwidth_n_spaces = i.cwidth - (e.column - 1) * e.space),
              (i.itemw = Math.round(i.cwidth_n_spaces / e.column)),
              (i.itemh = 0 == l ? i.cwidth_n_spaces / e.column / a : l / e.row),
              (e.aspectratio =
                0 == l ? e.aspectratio : i.itemw + ":" + i.itemh),
            ...
            punchgs.TweenLite.set(h, { paddingBottom: g + "%" });
          }
        } else {
          ...
          if (e.cobblesPattern != undefined && e.cobblesPattern.length > 2) {
            ...
            (w = parseInt(y.w, 0)), (v = parseInt(y.h, 0)), b++;
          }
          (w = w == undefined ? 1 : w),
            (v = v == undefined ? 1 : v),
        ...
        "even" == e.layout ||
          (n.hasClass("itemtoshow") &&
          (n.width() != i.itemw ||
            0 == n.css("opacity") ||
            "hidden" == n.css("visibility"))
            ? (i = prepareItemToMessure(n, i, o))
            : (adjustMediaSize(n, !0, i, e), (i.itemh = n.height()))),
          (i = animateGrid(r, e, i)),
          i.itemcounter++,
    ...
    var x = getBestFitColumn(e, jQuery(window).width(), "id");
    if (
      ((e.column = x.column),
      (e.columnindex = x.index),
      (e.mmHeight = x.mmHeight),
      ...
      (e.changedAnim = ""),
      setOptions(o, e),
      e.esgloader.length > 0 && "remove" != e.esgloaderprocess)
    ) {
  ...
  function prepareItemToMessure(e, t, a) {
    return (
      adjustMediaSize(e, !0, t, a.data("opt")), (t.itemh = e.outerHeight(!0)), t
    );
  }
  function animateGrid(e, t, a) {
    ...
    if (
      ...
      for (var r = 0; r < t.column; r++)
        a.currentcolumnheight[a.idealcol] > a.currentcolumnheight[r] &&
          (a.idealcol = r);
    ...
    if (
      ...
      "horizontal-slide" == a.anim
        ? ((a.waits = 0),
          ...
          t.oldpage != undefined &&
            t.oldpage > t.currentpage &&
            ((a.hsoffset = a.cwidth + parseInt(t.space)),
        ...
        : "vertical-slide" == a.anim &&
          ...
          t.oldpage != undefined &&
            t.oldpage > t.currentpage &&
            ((a.vsoffset = 0 - a.maxcalcheight - parseInt(t.space)),
            (a.vsoffsetout = 0 - a.maxcalcheight - parseInt(t.space)))),
      (a.outwaits = a.waits),
      "even" == t.layout &&
        a.cobblesx == undefined &&
        (a.x = a.x + a.col * t.space),
      a.cobblesx != undefined &&
        ((a.x = a.x + a.cobblesx * t.space),
      ...
      (a.outspeed = a.speed),
      "off" == t.animDelay && ((a.waits = 0), (a.outwaits = 0)),
      "scale" == a.anim
        ? (a.scale = 0)
        : "vertical-flipbook" == a.anim
          ? ((a.inxrot = -90),
            ...
            "off" == t.animDelay && ((a.waits = a.speed / 3), (a.outwaits = 0)))
          : "horizontal-flipbook" == a.anim
            ? ((a.inyrot = -90),
              (a.outyrot = -90),
    ...
    if (
      (!o.hasClass("itemtoshow") && !o.hasClass("fitsinfilter")) ||
      a.skipanim
    )
      a.itemouttowait++,
        punchgs.TweenLite.set(o, { zIndex: 5 }),
              ...
              : "fall" == a.anim
                ...
                : "horizontal-slide" == a.anim
                  ...
                  : "vertical-slide" == a.anim
                    ...
                    : "rotatefall" == a.anim && o.css("opacity") > 0
                      ? (punchgs.TweenLite.set(o, { zIndex: 300 - a.item }),
                        punchgs.TweenLite.to(o, a.outspeed / 2, {
                          force3D: "auto",
                          transformOrigin: a.outorigin,
      ...
      o.addClass("isvisiblenow"),
        "even" != t.layout
          ? ((a.currentcolumnheight[a.idealcol] =
              a.currentcolumnheight[a.idealcol] + a.itemh + parseInt(t.space)),
      ...
      "on" == t.rtl && (s = a.ulwidth - s - a.itemw),
        0 == o.css("opacity") && "fade" == a.anim
          ...
          : 0 == o.css("opacity") && "scale" == a.anim
            ...
            : 0 == o.css("opacity") && "rotatescale" == a.anim
              ? punchgs.TweenLite.set(o, {
                  width: a.itemw,
                  height: a.itemh,
                  scale: 1,
      ...
      t.container.trigger("itemsinposition"),
        punchgs.TweenLite.to(o, a.speed, {
          ...
          onComplete: function() {
            o.hasClass("itemtoshow") &&
              punchgs.TweenLite.set(o, { autoAlpha: 1, overwrite: "all" }),
              a.itemtowait--,
              0 == a.itemtowait &&
                (t.container.trigger("itemsinposition"),
  ...
  function fakePositions(e, t, a) {
    if (
      ...
      (o == undefined || r == undefined) &&
        ...
        "rotatefall" == t.anim
          ? (t.outwaits =
              (a.column - o) * t.delaybasic + r * (t.delaybasic * a.column))
          : (t.outwaits = o * t.delaybasic + r * (t.delaybasic * a.column));
    } else;
    return t;
  }
  ...
  function shiftGridFake(e, t) {
    return (
      ...
      e.fakecol == t.column &&
        ...
        e.fakerow == t.row && ((e.fakerow = 0), (e.pageitemcounterfake = 0))),
      e
    );
  }
            ...
            jQuery("head")
              ...
              .each(function() {
                jQuery(this).attr("src") ==
                  o + "://www.youtube.com/iframe_api" && (i = !1);
              }),
        ...
        try {
          if (
            ...
            jQuery("head")
              ...
              .each(function() {
                jQuery(this).attr("src") ==
                  n + "://fast.wistia.com/assets/external/E-v1.js" && (o = !1);
              }),
        ...
        try {
          if (
            ...
            jQuery("head")
              ...
              .each(function() {
                jQuery(this).attr("src") ==
                  n + "://w.soundcloud.com/player/api.js" && (o = !1);
              }),
              o && a.parentNode.insertBefore(t, a);
          }
        } catch (r) {}
      });
    var l = { youtube: a, vimeo: o, wistia: r, soundcloud: s, htmlvid: i };
    return l;
  }
  function toHHMMSS() {
    var e = new Date(),
  ...
  function stopAllVideos(e, t, a) {
    ...
    e && (o = "");
    for (
      var r = document.getElementsByClassName("tp-esg-item isvisiblenow"),
        i = 0;
      i < r.length;
      i++
    ) {
      for (
        var s = r[i].getElementsByClassName("esg-youtubevideo haslistener" + o),
          ...
          d = r[i].getElementsByClassName("esg-soundcloud" + o),
          c = 0;
        c < s.length;
        c++
      ) {
        var p = jQuery(s[c]),
          h = p.data("player");
        a != p.attr("id") &&
          (h.pauseVideo(), e && forceVideoInPause(p, !0, h, "youtube"));
      }
      for (c = 0; c < n.length; c++) {
        ...
        a != g &&
          (h.api("pause"),
          a === undefined && e && forceVideoInPause(p, !0, h, "vimeo"));
      }
      for (c = 0; c < l.length; c++) {
        var p = jQuery(l[c]),
          h = p.data("player");
        a != p.attr("id") &&
          (p.wistiaApi.pause(), e && forceVideoInPause(p, !0, h, "wistia"));
      }
      ...
      for (c = 0; c < d.length; c++) {
        var p = jQuery(d[c]),
          h = p.data("player");
        a != p.attr("id") &&
          (h.pause(), e && forceVideoInPause(p, !0, h, "soundcloud"));
      }
    }
  }
  function forceVideoInPause(e, t, a, o) {
    ...
    if (
      r.find(".esg-media-video").length > 0 &&
      ...
      if (s.length > 0)
        if (
          (is_mobile()
            ? (punchgs.TweenLite.set(i, { autoAlpha: 1 }),
              punchgs.TweenLite.set(s, { autoAlpha: 1 }),
              punchgs.TweenLite.set(e, { autoAlpha: 0 }))
            : (punchgs.TweenLite.to(i, 0.5, { autoAlpha: 1 }),
              punchgs.TweenLite.to(s, 0.5, { autoAlpha: 1 }),
              punchgs.TweenLite.to(e, 0.5, { autoAlpha: 0 })),
          t)
        )
          if ("youtube" == o)
            try {
  ...
  function prepareVimeo(e) {
    if (e.hasClass("haslistener") || "undefined" == typeof $f) {
      if (typeof $f != undefined && "undefined" != typeof $f) {
        var t = $f(e.attr("id"));
        return "function" == typeof t.api && e.hasClass("readytoplay")
          ? !0
          : !1;
      }
      return !1;
    ...
    try {
      ...
      e.attr("id", a);
      for (
        var o, r = e.attr("src"), i = {}, s = r, n = /([^&=]+)=([^&]*)/g;
        (o = n.exec(s));

      )
        i[decodeURIComponent(o[1])] = decodeURIComponent(o[2]);
      r =
        i.player_id != undefined
          ? r.replace(i.player_id, a)
          : r + "&player_id=" + a;
      try {
        r = r.replace("api=0", "api=1");
      } catch (l) {}
      (r += "&api=1"), e.attr("src", r);
      var u = e[0];
  ...
  function prepareVideo(e) {
    if (e.hasClass("haslistener"))
      try {
        ...
        return "function" == typeof a.play && e.hasClass("readytoplay")
          ? !0
          : !1;
      } catch (o) {
        return !1;
      ...
      var r = "videoid_" + Math.round(1e5 * Math.random() + 1);
      e.attr("id", r);
  ...
  jQuery.fn.extend({
      ...
      return (
        ...
        this.each(function() {
          ...
          var a = e,
            o = jQuery(this);
          if (
            ((a.contPadTop = parseInt(o.css("paddingTop"), 0)),
            (a.contPadBottom = parseInt(o.css("paddingBottom"), 0)),
            o == undefined)
          )
            return !1;
          if (
            ...
            "cobbles" == a.layout
              ? ((a.layout = "even"), (a.evenCobbles = "on"))
              : (a.evenCobbles = "off"),
            "true" != a.get && 1 != a.get)
          ) {
            if (
              ((a.get = !0),
              a.filterGroupClass == undefined || 0 == a.filterGroupClass.length
                ? (a.filterGroupClass = "#" + o.attr("id"))
                : (a.filterGroupClass = "." + a.filterGroupClass),
              1 == window.tplogs)
            )
              try {
                console.groupCollapsed(
                  "Essential Grid  2.0.5 Initialisation on " + o.attr("id")
                ),
            ...
            var i = o
              ...
              .find(".esg-relative-placeholder")
              .offset().left;
            ("on" == a.forceFullWidth || "on" == a.forceFullScreen) &&
              o
                .closest(".esg-container-fullscreen-forcer")
                .css({ left: 0 - i, width: jQuery(window).width() }),
                  ...
                  u &&
                    jQuery.each(u, function(e, t) {
                      (l -= jQuery(t).outerHeight(!0)),
                        l < a.minFullScreenHeight &&
                          (l = a.minFullScreenHeight);
                    });
                } catch (r) {}
              var d = o.find(".esg-overflowtrick").first(),
                c = o.find("ul").first();
              d.css({ display: "block", height: l + "px" }),
                c.css({ display: "block", height: l + "px" }),
                o
                ...
                (jQuery("head")
                  ...
                  .each(function() {
                    jQuery(this).attr("src") != undefined &&
                      jQuery(this)
                        .attr("src")
                        .indexOf("webfont.js") > 0 &&
                      (p = !1);
                  }),
                WebFontConfig.active == undefined && p)
              ) {
                WebFontConfig = {
                  google: { families: a.googleFonts },
                  active: function() {
                    t(o, a);
                  },
                  inactive: function() {
            ...
            "button" == a.loadMoreType
              ? (o.append(
                  '<div class="esg-loadmore-wrapper" style="text-align:center"><div class="esg-navigationbutton esg-loadmore">LOAD MORE</div></div>'
                ),
                (a.lmbut = a.container.find(".esg-loadmore")),
                (a.lmtxt =
                  a.loadMoreTxt + " (" + checkMoreToLoad(a).length + ")"),
                "off" == a.loadMoreNr && (a.lmtxt = a.loadMoreTxt),
                a.lmbut.html(a.lmtxt),
                a.lmbut.click(function() {
                  1 != a.lmbut.data("loading") && loadMoreItems(a);
                }),
                0 == checkMoreToLoad(a).length && a.lmbut.remove())
              : "scroll" == a.loadMoreType &&
                (o.append(
    ...
    esredraw: function(e) {
      ...
      if (a !== undefined) {
        if (e != undefined) {
          if (
            (e.space != undefined && (a.space = parseInt(e.space, 0)),
            ...
            if (
              ((a.forceFullWidth = e.forceFullWidth), "on" == a.forceFullWidth)
            ) {
              var o = t
                .parent()
                .parent()
          ...
          if (
            (e.rowItemMultiplier != undefined &&
              (a.rowItemMultiplier = e.rowItemMultiplier),
            e.responsiveEntries != undefined &&
              (a.responsiveEntries = e.responsiveEntries),
            e.column != undefined)
          ) {
  ...
  var vis = (function() {
    ...
    waitForLoads = function(e, t) {
      jQuery.each(e, function(e, a) {
        (a = jQuery(a)),
          a.hasClass("isvisiblenow") ||
            "add" === t.esgloaderprocess ||
            ((t.esgloaderprocess = "add"),
      ...
      var a = setInterval(function() {
        ...
        var o = 0;
        if (
          (e.find(".esg-media-poster").each(function(e) {
            var a = jQuery(this),
              r = a.attr("src"),
              i = a.parent();
            if (
            ...
            1 != a.data("lazydone") &&
              3 > o &&
              (o++, loadAllPrepared(jQuery(this), t)),
              "on" !== t.lazyLoad && punchgs.TweenLite.set(a, { autoAlpha: 1 });
          }),
        ...
        0 != o ||
          e.closest(".mainul").hasClass("gridorganising") ||
          (clearInterval(a), runGrid(t));
      }, 50);
      runGrid(t);
    };
})(jQuery),
  (function(e, t) {
    ...
    var r = !1,
      ...
      h = function(e, t) {
        for (var a, o = e.length, r = o; r--; ) (a = o - r - 1), t(e[a], a);
      },
      g =
        ...
        function(e) {
          ...
          for (
            a = 0 > a ? Math.ceil(a) : Math.floor(a), 0 > a && (a += t);
            t > a;
            a++
          )
      ...
      e.fn.extend({
        tinysort: function() {
          ...
          for (f = 0, w = arguments.length; w > f; f++) {
            var I = arguments[f];
            p(I)
              ? A.push(I) - 1 > O.length && (O.length = A.length - 1)
              : O.push(I) > A.length && (A.length = O.length);
          }
          for (
            A.length > O.length && (O.length = A.length),
              v = A.length,
              0 === v && ((v = A.length = 1), O.push({})),
              f = 0,
              w = v;
            w > f;
            f++
            ...
            var L = A[f],
              z = e.extend({}, e.tinysort.defaults, O[f]),
              Y = !(!L || "" === L),
              X = Y && ":" === L[0];
            C.push({
              sFind: L,
          ...
          return (
            y.each(function(a, o) {
              ...
              for (m = 0; v > m; m++) {
                ...
                n.push(
                  l.bData
                    ? u.data(l.oSettings.data)
                    : l.bAttr
                      ? u.attr(l.oSettings.attr)
                      : l.oSettings.useVal
                        ? u.val()
                        : u.text()
                ),
              ...
              var d = g.call(j, s);
              0 > d && ((d = j.push(s) - 1), (x[d] = { s: [], n: [] })),
                r.length > 0
                  ? x[d].s.push({ s: n, e: i, n: a })
                  : x[d].n.push({ e: i, n: a });
            }),
            h(x, function(e) {
              e.s.sort(Q);
