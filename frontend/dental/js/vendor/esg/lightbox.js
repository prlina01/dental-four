...
(function(e, t, n, r) {
  ...
  n.extend(u, {
    ...
    defaults: {
      ...
      tpl: {
        wrap:
          '<div class="esgbox-wrap" tabIndex="-1"><div class="esgbox-skin"><div class="esgbox-outer"><div class="esgbox-inner"></div></div></div></div>',
        ...
        next:
          '<a title="Next" class="esgbox-nav esgbox-next" href="javascript:;"><span></span></a>',
        prev:
          '<a title="Previous" class="esgbox-nav esgbox-prev" href="javascript:;"><span></span></a>'
      },
      openEffect: "fade",
      openSpeed: 250,
      openEasing: "swing",
    ...
    _start: function(e) {
      ...
      r_id =
        r_id.length > 0 && r_id !== undefined ? r_id.attr("id") : "rnoid_0";
      if (!r) {
        return false;
      }
      ...
      jQuery.each(u.group, function(_i, el) {
        ...
        el_id =
          el_id.length > 0 && el_id !== undefined ? el_id.attr("id") : "noid_0";

        jQuery.each(_tpgroup, function(_j, cel) {
          var cel_id = jQuery(cel.element[0].parentNode).closest(
            ".tp-esg-item"
          );
          cel_id =
            cel_id.length > 0 && cel_id !== undefined
              ? cel_id.attr("id")
              : "cel_noid_0";
          if (exists === false && cel.href === el.href && cel_id === el_id)
            exists = true;
        });
        if (!exists) {
          _tpgroup.push(el);
          if (el.href === r.href && r_id === el_id) e = _tpgroup.length - 1;
        }
      });
      u.group = _tpgroup;
    ...
    onUpdate: function(t, n) {
      if (this.list) {
        this.width = this.list
          ...
          .eq(0)
          .outerWidth(true);
        punchgs.TweenLite.set(this.list, {
          width: this.width * (n.group.length + 1)
        });
        punchgs.TweenLite.to(this.list, 0.5, {
...
jQuery("body").on("click", ".esgbox", function() {
  ...
  if (
    $this.attr("href").search("wistia") !== -1 &&
    !$this.hasClass("esgbox.iframe")
  ) {
    $this
      .addClass("esgbox.iframe")
      .attr("href", $this.attr("href") + "?autoPlay=true")
      .click();
    return false;
  }
});
